...
import { LayoutDashboard, Package, BarChart3, Settings, LogOut, ChevronLeft, Users, Tag, ShoppingBag, TrendingUp, Store, Menu, X } from "lucide-react";
...
const ADMIN_NAV = [
  ...
  { group: "ANALYTICS", items: [
    ...
    { label: "Blog Management", path: "/dashboard/admin/blog", icon: LayoutDashboard },
  ]},
    ...
    <>
      <div className="flex items-center justify-between px-4 py-4 border-b border-white/10">
        <div className="flex items-center gap-2">
          ...
          <span className="font-display text-lg text-white uppercase">Admin</span>
        </div>
    ...
    <div className="flex h-screen bg-warm-white overflow-hidden">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <header className="bg-white border-b border-outline-variant h-14 flex items-center px-4 md:px-6">
          ...
          <h1 className="font-display text-lg text-charcoal">Administration Panel</h1>
